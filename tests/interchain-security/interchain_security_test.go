...
import (
	...
	appConsumer "github.com/applelove-ventures/apple/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and apple consumer chain
